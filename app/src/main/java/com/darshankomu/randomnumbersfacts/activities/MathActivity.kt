...
import com.darshankomu.randomnumbersfacts.presenter.MathPresenter
import com.darshankomu.randomnumbersfacts.view.DateView
import com.darshankomu.randomnumbersfacts.view.MathView

class MathActivity : AppCompatActivity(), MathView {


    lateinit var recyclerView: RecyclerView
    lateinit var swipeRefresh: SwipeRefreshLayout
    lateinit var mathPresenter: MathPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mathPresenter = MathPresenter(this)


        mathPresenter.getMathData()
    ...
    override fun getResult(numberFacts: pojo?) {
        mNumberFactsAdapter = NumberFactsAdapter(this, numberFacts, itemShareLinkClick,4)
