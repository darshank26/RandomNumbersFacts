...
class TriviaActivity : AppCompatActivity(),TriviaView {


    lateinit var recyclerView: RecyclerView
    lateinit var swipeRefresh: SwipeRefreshLayout
    lateinit var triviaPresenter: TriviaPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        triviaPresenter = TriviaPresenter(this)


        triviaPresenter.getTriviaData()
    ...
    override fun getResult(numberFacts: pojo?) {
        mNumberFactsAdapter = NumberFactsAdapter(this, numberFacts, itemShareLinkClick,1)
