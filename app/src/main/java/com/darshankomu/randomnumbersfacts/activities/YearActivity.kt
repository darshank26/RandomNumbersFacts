...
import com.darshankomu.randomnumbersfacts.presenter.YearPresenter
import com.darshankomu.randomnumbersfacts.view.DateView
import com.darshankomu.randomnumbersfacts.view.YearView
import java.time.Year

class YearActivity : AppCompatActivity(), YearView {


    lateinit var recyclerView: RecyclerView
    lateinit var swipeRefresh: SwipeRefreshLayout
    lateinit var yearPresenter: YearPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        yearPresenter = YearPresenter(this)


        yearPresenter.getYearData()
    ...
    override fun getResult(numberFacts: pojo?) {
        mNumberFactsAdapter = NumberFactsAdapter(this, numberFacts, itemShareLinkClick,2)
